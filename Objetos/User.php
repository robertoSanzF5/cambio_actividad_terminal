...
{
    /** @var string */
    private $username, $nombre, $correo, $token, $hashToken, $cryptMethod, $state, $intentos, $maxIntentos, $cod_trabajador;
    /** @var int */
    private $userId;
    /** @var Centro */
...
// CONSTRUCTORES
    ...
    public static function userLogin($usuario, $password) {
        ...
        $resul = $db->selectOneRowFrom(
            'usuarios',
            ['nombre', 'correo', 'user_id', 'ultimo_centro', 'ultima_modificacion', 'password', 'intentos', 'cod_trabajador'],
            'usuario = $1',
            [$usuario]
        );
        ...
        if ($resul == null) {
            ...
            $user->cod_trabajador = $resul['cod_trabajador'];
...
// GETS Y SETS
    ...
    public function  getCodTrabajador(){
